    ...
    try:
        ...
        if is_railway:
            ...
            try:
                ...
                logger.error(f"Error starting Railway keep alive: {e}")
        else:
            # Système Replit keep alive (par défaut)
            ...
            logger.info("🔄 Système de maintien d'activité Replit démarré")
